...
#     "color": "RED"
# },
jenkin_root="https://release-jenkins.vietnamworks.com/job/Releases/job/pipeline/job/Schedule"
auth=('tuonghv', '11a3f85d63b2296b4af51936b25bd879ec')
# notification_gw = 'http://172.16.4.54:5550/'
notification_gw = 'http://172.16.4.54:5550/nagios_newdc'
jenkins_info_url ="https://navigosgroup.webhook.office.com/webhookb2/879882ef-7933-456d-ad94-877b2175ebf0@3b757257-990f-4253-aca4-ba5be9e05cca/IncomingWebhook/d8674fc751484df8a36798d701f911b0/0671d66e-c546-41cf-911a-1970ba2b138c"
...
def process_job_Object(data, path):
    if data['_class'] == 'com.cloudbees.hudson.plugins.folder.Folder':
        if data.get("name"):
...
def send_alert(msg, msg_short):
    ...
    try:
        ...
        x = requests.get(notification_gw, json=data, headers=headers)
        print(x.text)
    except:
