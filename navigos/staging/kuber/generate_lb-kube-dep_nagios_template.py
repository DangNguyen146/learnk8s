...
"""
production_path_template_output= "./kube_deployments.cfg"
release_path_template_output= "./kube_deployments.cfg"
staging_path_template_output= "./kube_deployments.cfg"
...
def generate_service_kubernetes_template(path_nagios_output, template_service, kuber_healthcheck_off):
  ...
  file_test = open("dsadsdsa.log", "w+")
  for ag in file:
    file_test.writelines(ag)
    file_test.writelines("check in list: ag not in kuber_healthcheck_off")
    file_test.writelines(str(ag not in kuber_healthcheck_off))
