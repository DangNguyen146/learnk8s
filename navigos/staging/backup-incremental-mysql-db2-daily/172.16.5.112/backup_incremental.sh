...
BinDir=/data/docker/volumes/537cccb012167a8b67a93626771369118f53220d83eb2537832cc47256071ffb/_data
BinFile=/data/docker/volumes/537cccb012167a8b67a93626771369118f53220d83eb2537832cc47256071ffb/_data/mysql-bin.index
for i in `sudo docker ps -a | grep "slave-db" | grep "Up"  | awk '{print $1}'`
do
